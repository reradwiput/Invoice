...
int main(){
    ...
    cout<<"1. Bakso Biasa				Rp. 12.000"<<endl;
    cout<<"2. Bakso Jumbo				Rp. 15.000"<<endl;
    cout<<"3. Tea (Es/panas)			Rp. 2.500"<<endl;
    cout<<"4. Jeruk (Es/panas)			Rp. 3.000"<<endl;
    cout<<"5. kopi (es/panas)                      Rp. 2.000"<<endl;
    cout<<"--------------------------------------------------------------"<<endl;
    	...
    	if (pilih[i]<=5){
    		...
    		if (pilih[i]==0){
				...
				switch (pilih[i]){
		    		...
		    		case 3 : menu[i]="Tea (es/panas)  "; harga[i]=2500; break;
		    		case 4 : menu[i]="Jeruk (es/panas)"; harga[i]=3000; break;
		    		case 5 : menu[i]="kopi (es/panas)"; harga[i]=2000; break;
